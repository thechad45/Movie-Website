...
gladiator = media.Movie("Gladiator",
                        "A war general becomes Gladiator",
...
tombstone = media.Movie("Tombstone", "A shoot-em-up featuring OK Corral",
                        "http://images.moviepostershop.com/tombstone-movie-poster-1993-1010259614.jpg",  # NOQA
                        "https://www.youtube.com/watch?v=XTWYKf5hXIg")

the_godfather = media.Movie("The Godfather",
                            "Story of the rise of the Corleone crime family",
                            "https://upload.wikimedia.org/wikipedia/en/1/1c/Godfather_ver1.jpg",  # NOQA
                            "https://www.youtube.com/watch?v=sY1S34973zA")

anchorman = media.Movie("Anchorman",
                        "A tale of the Channel 4 news team in San Diego",
...
hot_rod = media.Movie("Hot Rod", "Rod performs one big jump",
                      "https://upload.wikimedia.org/wikipedia/en/7/7f/Hot-rod-poster.jpg",  # NOQA
                      "https://www.youtube.com/watch?v=DhdrA9qz79o")


# List of movies to be passed in to the open_movies_page function
movies = [the_iron_giant, gladiator, tombstone,
          the_godfather, anchorman, hot_rod]
